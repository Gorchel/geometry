 ...
 */
class BuyWhitelistAnalyticBlanks implements BlanksInterface
{
    /**
     * @var array
     */
    ...
    public function config(): array
    {
        ...
        return [
            ...
            ['type' => 'nbsp'],
            ['type' => 'title', 'title' => 'Аналитика', 'tag' => 'strong'],
            ['type' => 'record', 'title' => 'Предполагаемая аренда кв.м.', 'value' => CustomHelper::numberFormat(CustomHelper::issetFieldIncludeArray($customs, 'custom-87923', '')), 'postfix' => 'руб.','second_tag' => 'strong', 'secondStyles' => 'color: #ff0000;'],
            ['type' => 'record', 'title' => 'Предполагаемая аренда в мес.', 'value' => CustomHelper::numberFormat(CustomHelper::issetFieldIncludeArray($customs, 'custom-87924', '')), 'postfix' => 'руб.','second_tag' => 'strong', 'secondStyles' => 'color: #ff0000;'],
            ['type' => 'record', 'title' => 'Предполагаемая окупаемость, месяцев', 'value' => CustomHelper::numberFormat(CustomHelper::issetFieldIncludeArray($customs, 'custom-88034', ''), 1), 'postfix' => 'мес.','second_tag' => 'strong', 'secondStyles' => 'color: #ff0000;'],
            ['type' => 'record', 'title' => 'Предполагаемая окупаемость, лет', 'value' => CustomHelper::numberFormat(CustomHelper::issetFieldIncludeArray($customs, 'custom-88035', ''), 1), 'postfix' => 'лет','second_tag' => 'strong', 'secondStyles' => 'color: #ff0000;'],
            ['type' => 'nbsp'],
