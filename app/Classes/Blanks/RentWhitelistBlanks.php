...
/**
 * Class RentWhitelistBlanks
 * @package App\Classes\Blanks;
 */
class RentWhitelistBlanks implements BlanksInterface
{
    /**
     * @var array
     */
    ...
    public function config(): array
    {
        ...
        return [
            ['type' => 'record', 'title' => 'Тип сделки', 'value' => CustomHelper::issetFieldIncludeArray($customs, 'custom-62518', ''), 'tag' => 'strong','secondStyles' => 'color: #ff0000;', 'firstStyles' => 'color: #ff0000;'],
            ...
            ['type' => 'nbsp'],
            ['type' => 'record', 'title' => 'Аренда в месяц', 'value' => CustomHelper::numberFormat(CustomHelper::issetFieldIncludeArray($customs, 'custom-76734', '')), 'postfix' => 'руб.', 'tag' => 'strong', 'secondStyles' => 'color: #ff0000;'],
            ['type' => 'record', 'title' => 'Аренда кв.м', 'value' => CustomHelper::numberFormat(CustomHelper::issetFieldIncludeArray($customs, 'custom-76733', '')), 'postfix' => 'руб.', 'tag' => 'strong', 'secondStyles' => 'color: #ff0000;'],
            ['type' => 'nbsp'],
