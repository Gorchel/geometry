...
/**
 * Class TorgiAnalitycBlanks
 * @package App\Classes\Blanks;
 */
class TorgiAnalyticBlanks implements BlanksInterface
{
    /**
     * @var array
     */
    ...
    public function config(): array
    {
        ...
        return [
            ...
            ['type' => 'record', 'title' => 'Предполагаемая перепродажа за кв.м', 'value' =>  CustomHelper::numberFormat(CustomHelper::issetFieldIncludeArray($customs, 'custom-88549', ''), 0, ' '), 'postfix' => 'руб.'],
            ...
            ['type' => 'record', 'title' => 'Аренда доход (сумма)', 'value' =>  CustomHelper::numberFormat(CustomHelper::issetFieldIncludeArray($customs, 'custom-88570', ''), 0, ' '),'tag' => 'strong', 'postfix' => 'руб.'],
            ['type' => 'nbsp'],
