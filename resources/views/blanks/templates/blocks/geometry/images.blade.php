        ...
        <tbody>
            <tr>
                <td style="border: 1px solid #000;
                    ...
                    <img style="max-width: 100%; max-height: 600px; margin-bottom:15px;" src="{{$renderImgConfig['map']['value']}}" />
                </td>
            </tr>
        </tbody>
    </table>
...
<table style="border-collapse: collapse; margin-top: 15px; width: 100%;">
    ...
    <tr>
        <td class="col-td" style="border: 1px solid #000;
                        padding: 4px" colspan="2"><div class="table-text">планировку в формате PDF или JPEG предоставляем по запросу</div></td>
    </tr>
    </tbody>
</table>
