    ...
    <form action="/webhook_objects" method="POST">
        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                ...
                <div class="row">
                    <div class="col-lg-12 form-group">
                        <label for="До метро">До метро (пешком)</label><input type="text" class="form-control input-sm" name="metro_distance" readonly="readonly" value="">
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12 form-group">
        ...
        function init() {
            ...
            function setPlacemark(coords) {
                ...
                myPlacemark.events.add('dragend', function () {
                    ...
                    updateData(placemarkCooed);
                });
            }

            function updateData(placemarkCooed) {
            ...
            function getMetro(coords) {
                ymaps.geocode(coords, {
                    ...
                    //До метро расстояние
                    var metroDistance = ymaps.coordSystem.geo.getDistance(coords, objects.get(0).geometry.getBounds()[0]);
                    $('[name="metro_distance"]').val(Math.floor(metroDistance));
